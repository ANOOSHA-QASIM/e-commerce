...
const Same = () => {
  return (
    <div>
      <div className="md:max-w-[1171px] w-full h-auto flex flex-col md:flex-row justify-between items-start md:items-center mt-8 md:mt-24 wrapper mb-20">
        {/* Left Side */}
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-4 md:gap-8 mt-4 md:mt-0">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <div className="w-full sm:w-[120px] h-[30px] border border-[#E7E6EF] flex items-center justify-between px-2 cursor-pointer">
              <p className="font-normal text-[#8A8FB9] text-[12px] truncate">
                Best Match
              </p>
